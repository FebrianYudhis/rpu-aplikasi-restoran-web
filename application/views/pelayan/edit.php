            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="form-group ml-3">
                        ...
                        <input class="form-control" type="text" placeholder="" readonly name="nomor_invoice" value="<?= $orderan['no_invoice'];?>">
                    </div>
                    <div class="form-group ml-3">
                        <label class="text-success">Nama Pemesan</label>
                        <input class="form-control" type="text" placeholder="" readonly name="nama_pemesan" value="<?= $orderan['nama_pemesan'];?>">
                    </div>
                    <div class="form-group ml-3">
                        <label class="text-success">Tanggal</label>
                        <input class="form-control" type="text" placeholder="" readonly name="tanggal" value="<?= $orderan['tanggal_pemesanan'];?>">
                    </div>
                </div>
                <form method="POST" action="<?= base_url('Pelayan/edit/').$orderan['no_invoice'];?>">
                    <div class="row">
                    ...
                    <table class="table table-hover table-bordered text-success table-responsive-sm">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?= $k['jumlah'];?></td>
                                <td>Rp. <?= $k['subtotal'];?></td>
                                <td><a href="<?= base_url('Pelayan/hapuspesanan2/').$k['no_order'].'/'.$orderan['no_invoice'];?>" class="badge badge-danger">Hapus</a></td>
                            </tr>
                            <?php
                                $no++;
                                endforeach;
                ...
                <a href="<?= base_url('Pelayan/selesaiedit/').$orderan['no_invoice'];?>" class="btn btn-success form-control">Selesai</a>
                </div>
            </div>
